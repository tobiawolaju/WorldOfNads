...
pat = re.compile(r"status_label\.text = \"✅ Server awake\. Loading game\.\.\.\"\s*# Load the real gameplay scene that connects via WebSocket\s*get_tree\(\)\.change_scene_to_file\(\"res://scenes/gameplay2d\.tscn\"\)")
