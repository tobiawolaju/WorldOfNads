...
- Implement all 6 stub contracts (WONsMatchEngine, WONsLootBox, WONsBridge, WONsRewards, WONsRegistry, WONsSkins) as real Solidity
- Add unit/integration tests across backend, contracts, and client (currently zero tests)
