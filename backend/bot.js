...
class BotClient {
  ...
  tick() {
    ...
    if (this.wasHolding && !iHoldChicken) {
      this.pickupCooldown = 5000;
    }
    this.wasHolding = iHoldChicken;
    ...
    if (CAN_PICK && !isHeld && this.pickupCooldown <= 0) {
